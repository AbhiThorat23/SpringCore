...
/**
 * Class to demonstrate Prototype Bean scope using Annotation. Every time new
 * bean is gets created, when we request for it in prototype scope.
 * 
 * @author Abhijit
 *
 */
public class SpringPrototypeScopeDemo {
	public static void main(String[] args) {
		 ...
		 * variable
		 */
		CarService car = applicationContext.getBean("mySwiftCar", CarService.class);
		CarService car1 = applicationContext.getBean("mySwiftCar", CarService.class);
